...
#' party} \item{np1}{Number of seats held by the first political party}
#' \item{p2}{Name of the second political party} \item{np2}{Number of seats
#' held by the second political party} \item{other}{Other} \item{vac}{Vacancy}
