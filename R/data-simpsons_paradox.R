...
#' \describe{
#'   \item{age_group}{Age of the person. Levels: `under 50`,  `50 +`.}
#'   \item{vaccine_status}{Vaccination status of the person. Note: the vaccinated group includes those who were only partially vaccinated. Levels: `vaccinated`, `unvaccinated`}
#'   \item{outcome}{Did the person die from the Delta variant? Levels: `death` and `survived`.}
#' }
#' @source [Public Health England: Technical briefing 20](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1009243/Technical_Briefing_20.pdf)
#' @keywords datasets
#' @examples 
#' library(dplyr)
#' library(scales)
