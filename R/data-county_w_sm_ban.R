...
#'   \item{fips}{a numeric vector}
#'   \item{pop2010}{a numeric vector}
#'   \item{pop2000}{a numeric vector}
#'   \item{age_under_5}{a numeric vector}
#'   \item{age_under_18}{a numeric vector}
#'   \item{age_over_65}{a numeric vector}
#'   \item{female}{a numeric vector}
#'   \item{white}{a numeric vector}
#'   \item{black}{a numeric vector}
#'   \item{native}{a numeric vector}
#'   \item{asian}{a numeric vector}
#'   \item{pac_isl}{a numeric vector}
#'   \item{two_plus_races}{a numeric vector}
#'   \item{hispanic}{a numeric vector}
...
#'   \item{hs_grad}{a numeric vector}
#'   \item{bachelors}{a numeric vector}
#'   \item{veterans}{a numeric vector}
...
#'   \item{firms}{a numeric vector}
#'   \item{black_owned_firms}{a numeric vector}
#'   \item{native_owned_firms}{a numeric vector}
...
#'   \item{sales_per_capita}{a numeric vector}
#'   \item{accommodation_food_service}{a numeric vector}
#'   \item{building_permits}{a numeric vector}
#'   \item{fed_spending}{a numeric vector}
#'   \item{area}{a numeric vector}
