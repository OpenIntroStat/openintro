...
#' \describe{
#'   \item{group}{Study group: `vaccine` (Pfizer-BioNTech COVID-19 vaccine administered)
#'   or `placebo`.}
#'   \item{outcome}{Study outcome: `COVID-19` or `no COVID-19`.}
#'   }
#' @source ["Pfizer-Biontech Announce Positive Topline Results Of Pivotal Covid-19 Vaccine Study In Adolescents"](https://www.pfizer.com/news/press-release/press-release-detail/pfizer-biontech-announce-positive-topline-results-pivotal).
