...
#' health, which includes stress, depression, and problems with emotions, not
#' good?  } \item{hrs1}{Hours worked each week.} \item{degree}{Educational
#' attainment or degree.} \item{grass}{Do you think the use of marijuana should
