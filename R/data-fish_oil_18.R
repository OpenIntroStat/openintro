...
#'   \item{major_cardio_event_after_2y}{Major cardiovascular event, excluding
#'   the first 2 years of follow-up.}
#'   \item{myocardial_infarction_after_2y}{Total myocardial infarction, excluding
#'   the first 2 years of follow-up.}
#'   \item{invasive_cancer_after_2y}{Invasive cancer of any type, excluding the
#'   first 2 years of follow-up.}
#'   \item{cancer_death_after_2y}{Death from cancer, excluding the first 2 years
#'   of follow-up.}
#'   \item{death_after_2y}{Death from any cause, excluding the first 2 years of
#'   follow-up.}
#' }
