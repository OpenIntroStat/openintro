...
- branch:
  ...
  The branch of the armed forces: `air force`, `army`, `marine corps`,
  `navy`.
...
- race:
  ...
  indian/alaskan native), `asian`, `black`, `multi` (multi-ethnic),
  `p/i` (pacific islander), `unk` (unknown), or `white`.
...
- rank:
  ...
  The numeric rank of the service member (higher number indicates higher
  rank).
