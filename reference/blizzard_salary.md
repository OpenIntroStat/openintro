...
disparities](https://www.bloomberg.com/news/articles/2020-08-03/blizzard-workers-share-salaries-in-revolt-over-wage-disparities).
...
#> Warning: Removed 56 rows containing non-finite outside the scale range (`stat_bin()`).
