...
#> ℹ Summaries were computed grouped by station, year, latitude, and longitude.
#> ℹ Output is grouped by station, year, and latitude.
#> ℹ Use `summarise(.groups = "drop_last")` to silence this message.
#> ℹ Use `summarise(.by = c(station, year, latitude, longitude))` for
