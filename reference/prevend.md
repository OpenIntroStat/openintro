...
Data from the Prevention of REnal and Vascular END-stage Disease
(PREVEND) study, which took place in the Netherlands. The study
collected various demographic and cardiovascular risk factors. This
dataset is from the third survey, which participants completed in
2003-2006; data are provided for 4,095 individuals who completed
cognitive testing with RFFT.
...
[doi:10.5061/dryad.6qs53](https://doi.org/10.5061/dryad.6qs53)
