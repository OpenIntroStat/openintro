...
at risk of stroke with some unexpected results. `stent30` represents the
results 30 days after stroke and `stent365` represents the results 365
days after stroke.
...
[doi:10.1056/NEJMoa1105335](https://doi.org/10.1056/NEJMoa1105335) . NY
