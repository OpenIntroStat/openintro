...
- group:
  ...
  Study group: `vaccine` (Pfizer-BioNTech COVID-19 vaccine administered)
  or `placebo`.
...
Vaccine Study In
Adolescents"](https://www.pfizer.com/news/press-release/press-release-detail/pfizer-biontech-announce-positive-topline-results-pivotal).
