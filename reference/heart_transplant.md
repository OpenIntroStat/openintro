...
- survtime:
  ...
  Number of days patients were alive after the date they were determined
  to be a candidate for a heart transplant until the termination date of
  the study
...
- transplant:
  ...
  Transplant status with levels `control` (did not receive a transplant)
  and `treatment` (received a transplant).
